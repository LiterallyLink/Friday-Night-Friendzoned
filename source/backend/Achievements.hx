...
class Achievements {
	...
	{
		createAchievement('friday_night_play',		{name: "Freaky on a Friday Night", description: "Play on a Friday... Night."});
		createAchievement('ur_bad',					{name: "What a Funkin' Disaster!", description: "Complete a Song with a rating lower than 20%."});
		createAchievement('ur_good',				{name: "Purrfectionist", description: "Complete a Song with a rating of 100%."});
		createAchievement('two_keys',				{name: "Just the Two of Us", description: "Finish a Song pressing only two keys."});
		createAchievement('bios_screen',			{name: "How Did We Get Here?", description: "For completionists only.", hidden: true});
		createAchievement('five_night_feddy',		{name: "ITS ME.", description: "Click on Golden Freddy's User on the login screen.", hidden: true});
		createAchievement('palette',		        {name: "A Whole New Palette", description: "Clicking outside of the FZPaint Window with the Dropper tool!"});
