...
import backend.PolygonSpectogram.VISTYPE;
import backend.audio.AudioVisualizer.CurAudioInfo;
  ...
  public function generateSection(start:Float = 0, seconds:Float = 1):Void
  {
    ...
    if (setBuffer)
    {
      ...
      for (i in 0...group.members.length)
      {
        ...
        var curAud:CurAudioInfo = AudioVisualizer.getCurAud(audioData, sampleApprox);
  ...
  public function updateFFT()
  {
    if (vis.snd != null)
    {
      ...
      if (setBuffer && doAnim)
      {
        ...
        {
          var curAud:CurAudioInfo = AudioVisualizer.getCurAud(audioData, i);
          i += 2;
